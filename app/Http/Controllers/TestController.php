...
class TestController extends Controller
{
    ...
    public function alipay()
    {
        ...
        $version = '1.0';
        $return_url = 'http://api.1905.ruijiang.xyz/test/alipay/return';       // 支付宝同步通知
        $notify_url = 'http://api.1905.ruijiang.xyz/test/alipay/notify';        // 支付宝异步通知地址
        $biz_content = '';
        // 请求参数
